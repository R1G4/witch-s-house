...
#pragma endregion
	...
	SCENEMANAGER->changeScene("3층개구리방");
	/////////////////UI 일단 주석처리/////////////
	//addScene();
...
void playGround::addScene()
{
	...
	SCENEMANAGER->addScene("3층3", new third3);		//예비용?? 고민중
	SCENEMANAGER->addScene("3층첫번째데드씬", new thirdFloorDead);
	SCENEMANAGER->addScene("3층개구리방", new thirdFrogRoom);
	//SCENEMANAGER->addScene("3층두번째데드씬", new thirdFloorDead);
}
