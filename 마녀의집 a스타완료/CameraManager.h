...
public:
	...
	void txtRender(string, Vector2 vec, int size, const D2DRenderer::DefaultBrush& defaultbrush = D2DRenderer::DefaultBrush::White, const DWRITE_TEXT_ALIGNMENT& align = DWRITE_TEXT_ALIGNMENT_LEADING, const wstring& font = L"맑은고딕");
};
