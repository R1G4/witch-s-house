...
void bossStage_3::activeTrigger()
{
	...
	if ((IntersectRectToRect(&pFrc, &_vTrigger[3].tile) || IntersectRectToRect(&pFrc, &_vTrigger[7].tile)
		|| IntersectRectToRect(&pFrc, &_vTrigger[8].tile)|| IntersectRectToRect(&pFrc, &_vTrigger[9].tile))
		&& !_isBossAppeal)
	{
